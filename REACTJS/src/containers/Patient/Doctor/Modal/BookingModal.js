      ...
      <Modal
        ...
        <div className="booking-modal-content">
                ...
                <div className="row" >
                    <div className="col-6 form-group" >
                        ...
                        <input className="form-control" 
                            ...
                            onChange={(event) => this.handelOnChangeInput(event,'fullName')}
                        />
                    </div>
                    ...
                    <div className="col-6 form-group" >
                        ...
                        <input className="form-control"
                            ...
                            onChange={(event) => this.handelOnChangeInput(event,'phoneNumber')}
                        />
                    </div>
                    <div className="col-6 form-group" >
                    <label>
                    ...
                    <div className="col-12 form-group" >
                        ...
                        <input className="form-control"
                            ...
                            onChange={(event) => this.handelOnChangeInput(event,'reason')}
                        />
                    </div>
                    <div className="col-6 form-group" >
                        <label>
            ...
            <div className="booking-modal-footer">
                <button className="bnt-booking-confirm" 
                    onClick ={() => this.handleConfirmBooking()}
                >
                    <FormattedMessage id="patient.booking-modal.btnConfirm"/>
                </button>
                <button className="bnt-booking-cancel" 
                    onClick={closeBookingClose}
                >
